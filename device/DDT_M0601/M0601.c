...
void send_wheel_speed(float left_wheel_speed,float right_wheel_speed){
...
/**
	*	@name		Send_Motor
  * @brief  The motor is based on RS485 communication. This function sends data to the motor.
  * @param  None
  * @retval None
  */
...
/**
	*	@name		CRC8_Table
  * @brief  This function is used to Get CRC8 check value.Get CRC8 check value.CRC verification is required for data frames sent by most function functions.
...
/**
	*	@name		Get_Motor
  * @brief  This function is used Get other feedback from the motor.The difference between this function and the data frame obtained after transmitting the drive motor function lies in the feedback temperature.
  * @param  ID,Receiver
  * @retval None
  */
